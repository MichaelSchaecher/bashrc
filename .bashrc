...
function __prompt () {
    ...
    [[ $exit_code -eq 0 ]] && color=$COLOR_SUCCESS || color=$COLOR_ERROR
...
[[ -f ~/.config/function ]] && source ~/.config/function
...
GCC_COLORS="error=$COLOR_ERROR:warning=$COLOR_WARNING:note=$COLOR_NOTE:"
export GCC_COLORS+="caret=$COLOR_CARET:locus=$COLOR_LOCUS:quote=$COLOR_QUOTE"
...
export LESS_TERMCAP_mb=$'\e['"$COLOR_WARNING"'m'
export LESS_TERMCAP_md=$'\e[1;'"$COLOR_TITLE"'m'
export LESS_TERMCAP_me=$'\e[0m'
export LESS_TERMCAP_se=$'\e[0m'

# begin reverse video → magenta background, white foreground
export LESS_TERMCAP_so=$'\e[1;45;'"$COLOR_FG_SO"'m'
